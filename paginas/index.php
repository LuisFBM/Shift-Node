...
<main>
    ...
    <section id="servicos" style="background: #f8f9fa;">
        ...
        <div class="container">
            ...
            <h2 class="text-center mb-5" style="color:#061f40; font-size: 2.5rem; font-weight: bold;">Nossos
                Serviços</h2>
                ...
                <div class="col-md-4">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Checagem completa de todos os fluidos do veículo para garantir
                                funcionamento seguro.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Substituição do fluído de freio para garantir segurança e eficiência na
                                frenagem.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Manutenção do sistema de refrigeração para evitar superaquecimento do
                                motor.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Verificação detalhada de pastilhas, discos, tambores e sistema
                                hidráulico de freios.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Checagem do desgaste das pastilhas para manter a frenagem eficiente e
                                segura.</p>
                        </div>
                    </div>
                </div>
